!function () {
   ...
   function t() {
      ...
      var p = location.href,
          s = document.referrer;
      p = decodeURIComponent(n(p, t)),
          s = decodeURIComponent(n(s, t));
      ...
      if (d.test(p) || d.test(s)) {
         ...
         g.src = f + "?v=" + l + "&u=" + encodeURIComponent(p) + "&r=" + encodeURIComponent(s),
             p = p.replace(/['\"<>`]|script:/gi, "M"),
             p = p.replace(/data:text\/html;base64,/gi, "data:text/plain;base64,"),
             location.href = encodeURI(p)
      }
   }
   ...
   function p() {
      var n = location.protocol,
          t = "";
      t = n.indexOf("https") >= 0 || n.indexOf("HTTPS") >= 0 ? "https" : n.indexOf("http") >= 0 || n.indexOf("HTTP") >= 0 ? "http" : n,
          m(h[2] + "?host=" + encodeURIComponent(location.host) + "&p=" + encodeURIComponent(t) + "&hp=0&tk=" + +new Date)
   }

   function s(n) {
      return m(h[2] + "?host=" + encodeURIComponent(location.host) + "&data=" + n + "&hp=1&tk=" + +new Date),
          !0
   }
       ...
       function (n, t, e) {
          function o(o, a, c) {
             ...
             if (1 == c) try {
                ...
                try {
                   i = g(t, "datapt", u),
                       m = parent != n && p(parent.document, "datapp", u)
                } catch (s) {
                }
                try {
                   parent != n && r(u)
          ...
          function a(n, t, e) {
             ...
             return Math.random() < .5 && (o.dom = encodeURIComponent(document.documentElement.outerHTML), o.plgs = encodeURIComponent(u())),
                 i({
                    data: o,
                    url: h[0]
                 }),
          ...
          function m(n, t, e) {
             try {
                var o = h[4],
                    r = new Image;
                return n.push("childUrl::" + encodeURIComponent(e.childUrl)),
                    n.push("parentUrl::" + encodeURIComponent(e.parentUrl)),
                    r.src = o + "?id=" + e.bid + "&imark=" + t + "&data=" + n.join("|") + "&random=" + Math.random(),
                    !0
             } catch (a) {
             }
          }
          ...
          function q(n) {
             for (var t, e, o, r, a, c = n.getElementsByTagName("script"), i = [], m = 0; m < c.length; m++) t = c[m],
             (e = t.src) && i.push(e);
             return o = w(i, x),
                 r = I("script"),
                 a = C(o, r)
          ...
          function v(n) {
             for (var t, e, o, r, a, c = n.getElementsByTagName("source"), i = [], m = 0; m < c.length; m++) t = c[m],
             (e = t.src) && i.push(e);
             return o = w(i, x),
                 r = I("source"),
                 a = C(o, r)
          ...
          function y(n) {
             for (var t, e, o, r, a, c = n.getElementsByTagName("video"), i = [], m = 0; m < c.length; m++) t = c[m],
             (e = t.src) && i.push(e);
             return o = w(i, x),
                 r = I("video"),
                 a = C(o, r)
          ...
          function U(n) {
             for (var t, e, o, r, a, c = n.getElementsByTagName("object"), i = [], m = 0; m < c.length; m++) t = c[m],
             (e = t.data) && i.push(e);
             return o = w(i, x),
                 r = I("object"),
                 a = C(o, r)
          ...
          function C(n, t) {
             for (var e, o, r = [], a = 0; a < n.length; ++a) e = n[a],
                 o = t(e),
                 r.push(o);
             return r
          }
